...
const Create = () => {
    ...
    return(
        <Box className = {classes.container}>
            <img className={classes.image} src={img} onError={(e) => { e.target.onerror = null; e.target.src = url; }} alt="BlogBanner" />
            <FormControl className = {classes.form}>
                ...
                <InputBase 
                    ...
                    name = 'title'
                />
                <Button onClick = {() => savePost()} variant = "contained" color = "secondary">Post</Button>
            </FormControl>
